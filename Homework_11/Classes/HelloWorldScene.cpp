...
bool HelloWorld::init()
{
	...
	auto label = Label::createWithBMFont("fonts/futura-48.fnt", "Homework 11");
	...
	auto item1 = MenuItemLabel::create(Label::createWithSystemFont("Play", "fonts/SketchFlow Print.ttf", label->getContentSize().height), CC_CALLBACK_1(HelloWorld::PlayMenu, this));
	auto item2 = MenuItemLabel::create(Label::createWithTTF("Fly", "fonts/SketchFlow Print.ttf", label->getContentSize().height), CC_CALLBACK_1(HelloWorld::Move, this));
	auto item3 = MenuItemLabel::create(Label::createWithTTF("Time", "fonts/SketchFlow Print.ttf", label->getContentSize().height), CC_CALLBACK_1(HelloWorld::Schedule_, this));
	auto item4 = MenuItemLabel::create(Label::createWithTTF("Pause", "fonts/SketchFlow Print.ttf", label->getContentSize().height), CC_CALLBACK_1(HelloWorld::Pause, this));
    ...
    // add bg
	auto bgsprite = Sprite::create("back.jpg");
	float odds;
	float oddsY;
	...
	//
	//
	timerStr = Label::createWithTTF("0.0", "fonts/arial.ttf", 40);
...
void HelloWorld::Move(Ref *ref){
	auto moveSprite = Sprite::create("player.png");
