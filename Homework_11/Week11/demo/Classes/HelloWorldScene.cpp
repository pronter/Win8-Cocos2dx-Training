...
bool HelloWorld::init()
{
	...
	auto item1 = MenuItemLabel::create(Label::createWithSystemFont("Play", "Cobel", label->getContentSize().height), CC_CALLBACK_1(HelloWorld::PlayMenu, this));

	auto item2 = MenuItemLabel::create(Label::createWithTTF("Move", "fonts/Marker Felt.ttf", label->getContentSize().height), CC_CALLBACK_1(HelloWorld::Move, this));
	auto item3 = MenuItemLabel::create(Label::createWithTTF("Schedule", "fonts/Marker Felt.ttf", label->getContentSize().height), CC_CALLBACK_1(HelloWorld::Schedule_, this));
